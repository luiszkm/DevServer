...
| tile strip gate and empty frame (2), added after verification round 2 | one 32x32 cell (or smaller) runs no strip rule C1 · empty frame of a 128x32 tile C1 | - |
| strip shape guard (2), added after verification round 3 | tile 128x48 C1 · anim 100x64 C2 | - |
