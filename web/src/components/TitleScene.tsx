...
const SIGNS = [
  { label: "SERVER", href: "/server", style: { left: "17.1%", top: "46.7%", width: "14.6%", height: "5.2%" }, chip: false },
  ...
  // The server building: its chip sits in the top-right corner, as in the prototype.
  { label: "SALA DE SERVIDORES", href: "/server", style: { left: "68.5%", top: "39.2%", width: "26.4%", height: "33%" }, chip: true, corner: true },
];
  ...
  return (
    <section className="scene title-scene" aria-label="TÍTULO">
      <div className="title-art">
        ...
        {SIGNS.map((s) => (
          <Link key={s.label} href={s.href} aria-label={s.label} className={`hotspot${"corner" in s ? " corner" : ""}`} style={s.style}>
